...
void PostProcessor::Start()
{
	...
	auto post_proc_start_time = std::chrono::high_resolution_clock::now();	
	...
	auto post_proc_stop_time = std::chrono::high_resolution_clock::now();
	auto post_proc_exec_duration = std::chrono::duration_cast<std::chrono::milliseconds>(post_proc_stop_time - post_proc_start_time).count();
    std::cout << "Time taken for starting post processor: " << post_proc_exec_duration << " ms" << std::endl;
}
