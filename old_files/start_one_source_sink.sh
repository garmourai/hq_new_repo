...
LOCAL_COMMAND2="python start_stop_trigger_app_one_sink.py"       # Replace this with the command you want to run locally
...
REMOTE_HOST_1="192.168.0.25"       # Change this to the remote server address
